  ...
  return (
    <div className="grid gap-4 md:grid-cols-3">
      <Card>
        ...
        <div className="text-sm text-zinc-700 dark:text-zinc-400">ГОСТ Р ИСО 9001‑2015</div>
      </Card>
      <Card>
        ...
        <div className="text-sm text-zinc-700 dark:text-zinc-400">Федеральные сети и дилеры</div>
      </Card>
      <Card>
        ...
        <div className="text-sm text-zinc-700 dark:text-zinc-400">Инструкции, паспорта, консультации</div>
      </Card>
    </div>
  );
}
