...
export function TelegramIcon(props: SVGProps<SVGSVGElement>) {
  return (
    <svg viewBox="0 0 24 24" width="20" height="20" fill="none" aria-hidden="true" {...props}>
      ...
      <path d="M9 13l8-6-6 8" stroke="currentColor" strokeWidth="1.5"/>
    </svg>
  );
}
...
export function YouTubeIcon(props: SVGProps<SVGSVGElement>) {
  return (
    <svg viewBox="0 0 24 24" width="20" height="20" fill="none" aria-hidden="true" {...props}>
      ...
      <path d="M11 10l5 2.5-5 2.5V10z" fill="currentColor"/>
    </svg>
  );
}
...
export function WhatsAppIcon(props: SVGProps<SVGSVGElement>) {
  return (
    <svg viewBox="0 0 24 24" width="20" height="20" fill="none" aria-hidden="true" {...props}>
      ...
      <path d="M9.5 8.5c-.5 1 .5 2.5 1.5 3.5s2.5 2 3.5 1.5c.5-.2 1-.8 1.2-1.2" stroke="currentColor" strokeWidth="1.5"/>
    </svg>
  );
}
